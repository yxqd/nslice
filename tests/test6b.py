...
"""
Try xaxis, yaxis, ... options for "slice" method
"""
...
axes = [
    histogram.axis('h1', boundaries=edges[0]),
    histogram.axis('k1', boundaries=edges[1]),
    ]
h = histogram.histogram('I(h,k) rotated 45deg', axes=axes, data=H)
hh.dump(h, 'I_h1k1_6b.h5')
